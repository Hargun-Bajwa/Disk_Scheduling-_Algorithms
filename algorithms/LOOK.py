#LOOK is similar to the scan algorith only difference is that we access largest vale rather than last value at end
# will use same code and will remove the last disk value part
from algorithms import FCFS
def look(arr, current_position):
